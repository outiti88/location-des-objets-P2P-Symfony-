 ...
 */
final class Version20200519042447 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE comment_client (id INT AUTO_INCREMENT NOT NULL, booking_id INT NOT NULL, author_id INT NOT NULL, client_id INT NOT NULL, created_at DATETIME NOT NULL, rating INT NOT NULL, positive_comment LONGTEXT NOT NULL, negative_comment LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_D575C473301C60 (booking_id), UNIQUE INDEX UNIQ_D575C47F675F31B (author_id), UNIQUE INDEX UNIQ_D575C4719EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE booking CHANGE confirm confirm INT NOT NULL');
        $this->addSql('ALTER TABLE premium CHANGE start_date start_date DATETIME DEFAULT \'NULL\', CHANGE end_date end_date DATETIME DEFAULT \'NULL\'');
