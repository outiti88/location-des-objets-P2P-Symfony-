 ...
 */
final class Version20200523205539 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE booking ADD vu_notif_client TINYINT(1) NOT NULL, ADD vu_notif_prop TINYINT(1) NOT NULL, CHANGE confirm confirm INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ad CHANGE date_fin date_fin DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE booking DROP vu_notif_client, DROP vu_notif_prop, CHANGE confirm confirm INT DEFAULT NULL');
        $this->addSql('ALTER TABLE premium CHANGE start_date start_date DATETIME DEFAULT \'NULL\', CHANGE end_date end_date DATETIME DEFAULT \'NULL\'');
